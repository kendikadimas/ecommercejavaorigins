    ...
    return (
      <div className="bg-white min-h-[80vh] flex items-center justify-center p-4 font-sans py-12">
        <div className="bg-[#EEF6E0] border border-[#B4D397] rounded-2xl w-full max-w-md p-6 sm:p-8 shadow-xl text-center space-y-4">
          ...
          <h1 className="text-xl font-extrabold text-[#26421F]">Cek Email Anda</h1>
          <p className="text-sm text-gray-600 font-normal">
            Jika email terdaftar, kami sudah mengirim tautan reset password ke{' '}
            <span className="font-bold text-[#276F27]">{email}</span>. Tautan berlaku 1 jam.
          </p>
          <Link
            href="/login"
    ...
    <div className="bg-white min-h-[80vh] flex items-center justify-center p-4 font-sans py-12">
      <div className="bg-[#EEF6E0] border border-[#B4D397] rounded-2xl w-full max-w-md p-6 sm:p-8 shadow-xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-[#26421F]">Lupa Password</h1>
          <p className="text-xs text-gray-500 font-normal">
            Masukkan email terdaftar — kami akan kirim tautan untuk mereset password Anda.
          </p>
        </div>
