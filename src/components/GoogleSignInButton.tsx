...
export const GoogleSignInButton: React.FC<{ label?: string; redirect?: string }> = ({
  ...
  return (
    <a
      href={href}
      className="w-full flex items-center justify-center gap-2.5 py-3 rounded-xl border border-[#C9D3BE] bg-white hover:bg-[#F2F7E9] text-[#26421F] font-extrabold text-xs uppercase tracking-wider transition-colors shadow"
    >
